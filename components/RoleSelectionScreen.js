  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        ...
        {/* Continue Button - Only Visible When a Role is Selected */}
        {selectedRole && (
          <TouchableOpacity
...
const styles = StyleSheet.create({
  ...
  buttonContainer: {
    ...
    alignItems: "center",
    position: "absolute",
    bottom: 120, // Moved up slightly for better spacing
  },
  navButton: {
    flexDirection: "row",
    alignItems: "center",
    justifyContent: "center",
    width: 160, // Equal width for both buttons
    paddingVertical: 14,
    borderRadius: 12,
    borderWidth: 2,
  },
  ...
  paginationContainer: {
    ...
    marginTop: 15,
    position: "absolute",
    bottom: 50, // Lowered for better spacing
  },
  dot: {
    width: 10,
    height: 10,
